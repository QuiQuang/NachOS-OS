...
AddrSpace::AddrSpace(OpenFile *executable)
{
   ...
   // addrLock->P();
    ...
    // Tim cac khung trang con trong tren RAM
    int numclear = gPhysPageBitMap->NumClear();

    // Neu so khung trang khong du de chay chuong trinh moi
...
//Cai dat phuong thuc khoi tao voi tham so dau vao la filename.
...
//
//   // addrLock->P();
//    printf("\ncode: %d, initdata: %d, uinitdata: %d, stack: %d",noffH.code.size,noffH.initData.size,noffH.uninitData.size,UserStackSize);
...
//    int numclear = gPhysPageBitMap->NumClear();
//
//    // In ra kich thuoc cua chuong trinh nay
